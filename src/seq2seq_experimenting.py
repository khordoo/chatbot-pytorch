...
class TrainingSession:
    ...
    def batch_generator(self, sources, targets, batch_size, shuffle=False, drop_last=False):
...
if __name__ == '__main__':
    tokenizer = Tokenizer(contractions_dict=None, min_token_frequency=MIN_TOKEN_FREQ,
